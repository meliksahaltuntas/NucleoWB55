 ...
 */
static const uint8_t CUSTOM_DATA_SERVICE_UUID[2] = {0x34, 0x12}; // Little-endian
static const uint8_t DATA_STORAGE_CHAR_UUID[2] = {0x35, 0x12};
static const uint8_t DATA_COMMAND_CHAR_UUID[2] = {0x36, 0x12};
static const uint8_t DATA_STATUS_CHAR_UUID[2] = {0x37, 0x12};
